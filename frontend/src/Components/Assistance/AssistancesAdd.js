...
export default function ProfessorEdit(props) {
  ...
  const AddAssistance = (e) => {
    ...
    axios.post("http://localhost:3000/user/assistance", data).then((result) => {
      props.history.push("/");
    });
  };
  ...
  const onChange = (e) => {
    e.presist = () => {};
    setAssistance({ ...assistance, [e.target.name]: e.target.value });
  };
          ...
          <form onSubmit={AddAssistance}>
            ...
            <div>
              <input
                ...
                className="form-control"
                defaultValue={assistance.Family_name}
                onChange={onChange}
              />
            </div>
            ...
            <div>
              <select
                ...
                name="Department"
                className="form-control"
                defaultValue={assistance.Department}
                onChange={onChange}
              ></select>
            </div>
            ...
            <div>
              <input
                ...
                placeholder="Address"
                className="form-control"
                defaultValue={assistance.Address}
                onChange={onChange}
              />
            </div>
            ...
            <div>
              <input
                ...
                className="form-control"
                defaultValue={assistance.Phone_number}
                onChange={onChange}
              />
            </div>
